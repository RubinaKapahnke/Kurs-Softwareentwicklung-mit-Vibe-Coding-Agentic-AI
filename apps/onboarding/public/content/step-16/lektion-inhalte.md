...
Du weisst, wie du nach dem Onboarding konkret in den Gesamtkurs startest und was dein erster sinnvoller nächster Lektion ist.
...
1. Du weisst, welche Übung als Naechstes dran ist.
...
- Übung gefunden, aber Kontext unklar: Erst die Modulquelle oeffnen.
- Unsicher, welches Repo offen ist: Ordnername und `git remote -v` pruefen.

## Erfolgskriterium

Du kannst nach dem Onboarding selbstständig in den Gesamtkurs starten und den ersten passenden Arbeitsschritt auswaehlen.
