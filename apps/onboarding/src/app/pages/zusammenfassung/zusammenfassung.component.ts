...
export class ZusammenfassungComponent {
  ...
  readonly nextStepsUrl = 'https://github.com/RubinaKapahnke/vibe-coding-0426/blob/main/COURSE_MILESTONES.md';
  ...
  readonly vscodeCourseEntryHints = [
    ...
    'Tippe COURSE_MILESTONES.md und bestaetige mit Enter.'
  ] as const;
