...
1. [Prompting: Grundlagen](./01-prompting-grundlagen.md)
2. [PRD: Grundlagen](./02-prd-grundlagen.md)
3. [Prompt-Dateien: Grundlagen](./03-prompt-dateien-grundlagen.md)
...
- [ ] Ich kann einfache, klare Aufforderungen formulieren, statt zu hoffen, dass die KI mein Problem loest.

### Should have

- [ ] Ich kann ein einfaches PRD (Product Requirements Document) schreiben, das die KI verstehen kann.
- [ ] Ich verstehe, warum strukturierte Daten (z. B. JSON) einer KI helfen, besser zu antworten.
...
- [ ] Ich verstehe die Grenzen der KI und weiss, welche Aufgaben besser manuell geloest werden.

## Wenn du etwas nachholen willst

- Fuer Prompting-Grundlagen: [Prompting: Grundlagen](./01-prompting-grundlagen.md)
- Fuer PRD: [PRD: Grundlagen](./02-prd-grundlagen.md)
- Fuer Prompt-Dateien: [Prompt-Dateien: Grundlagen](./03-prompt-dateien-grundlagen.md)
