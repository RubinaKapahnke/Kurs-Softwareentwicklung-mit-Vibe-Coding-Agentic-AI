...
| Ordnerinhalt anzeigen | `dir` | `ls` | `dir` im Repo-Ordner zeigt Dateien wie `README.md`, `AGENTS.md` und Ordner wie `course/` | `ls -la` (macOS) zeigt auch versteckte Dateien wie `.github/`. |
