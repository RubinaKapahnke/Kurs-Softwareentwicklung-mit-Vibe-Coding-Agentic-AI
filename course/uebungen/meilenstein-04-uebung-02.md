...
- [course-library/08-programmierlogik/01-programmierlogik-grundlagen.md](../course-library/08-programmierlogik/01-programmierlogik-grundlagen.md)
- [course-library/08-programmierlogik/02-programmierlogik-code-lesen.md](../course-library/08-programmierlogik/02-programmierlogik-code-lesen.md)
...
Quelle: [course-library/08-programmierlogik/02-programmierlogik-code-lesen.md](../course-library/08-programmierlogik/02-programmierlogik-code-lesen.md) (Schritt 1)
...
Quelle: [course-library/08-programmierlogik/02-programmierlogik-code-lesen.md](../course-library/08-programmierlogik/02-programmierlogik-code-lesen.md) (Schritte 2 und 3)
...
Quelle: [course-library/08-programmierlogik/01-programmierlogik-grundlagen.md](../course-library/08-programmierlogik/01-programmierlogik-grundlagen.md)
...
Quelle: [course-library/08-programmierlogik/02-programmierlogik-code-lesen.md](../course-library/08-programmierlogik/02-programmierlogik-code-lesen.md) (Schritt 4)
...
Quelle: [course-library/08-programmierlogik/02-programmierlogik-code-lesen.md](../course-library/08-programmierlogik/02-programmierlogik-code-lesen.md) (Schritt 5)
Quelle: [course-library/07-architecture-foundations/02-architecture-foundations-praxis.md](../course-library/07-architecture-foundations/02-architecture-foundations-praxis.md)
...
- [ ] course/course-library/06-ai-instructions/01-prompting-grundlagen.md: gezielte Rueckfragen im Chat
...
- **Strukturkontext in der PRD-Datei pflegen** ([course-library/07-architecture-foundations/02-architecture-foundations-praxis.md](../course-library/07-architecture-foundations/02-architecture-foundations-praxis.md))
- **Copilot Chat mit Datei-Kontext nutzen** ([course-library/02-vscode/02-vscode-copilot.md](../course-library/02-vscode/02-vscode-copilot.md))
...
- **Beobachtungen strukturiert in Markdown dokumentieren** ([course-library/01-markdown/01-markdown-grundlagen.md](../course-library/01-markdown/01-markdown-grundlagen.md))
