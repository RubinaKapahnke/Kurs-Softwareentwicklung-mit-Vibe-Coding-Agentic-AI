...
### 29.04.
- **Was ich gemacht habe:** neuen Branch angelegt, synchronisiert, Fehler in der Arbeitsanweisung korrigiert und committed, Lernstand dokumentiert
...
- `code` – Datei direkt in VS Code öffnen
- `echo` vs `New-Item` – Unterschiede noch zu klären

**Modul-Zuordnungen (aus Uebung 02, Aufgabe 4):**
| Situation | Modul | Datei konkret |
|---|---|---|
| Ich weiss nicht mehr, wie ich eine Datei im Terminal anlege | 04-git | 03-git-befehlsuebersicht.md |
