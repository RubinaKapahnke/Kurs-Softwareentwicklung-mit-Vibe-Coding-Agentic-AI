...
2. **Erkunde die Ordnerstruktur:** Klicke auf verschiedene Ordner:
   ...
   - `course/03-course-library/` - Welche Module sehen Sie?
   - `course/02-course-exercises/` - Welche Übungen sind schon vorhanden?
...
3. **Finde und öffne diese wichtigen Dateien:**
   ...
   - Lese die Überschrift "🗺️ Course Milestones: Zentrale Meilensteine"
...
- Wo findest du die Lernmaterial-Module? (`course/03-course-library/`)
...
- [ ] Ich weiß, wo die Übungsaufgaben sind (`course/02-course-exercises/`)
- [ ] Ich weiß, wo die Lernmaterial-Module sind (`course/03-course-library/`)
