...
Quelle: [course-library/06-ai-instructions/03-prompt-dateien-grundlagen.md → Aufbau einer Prompt-Datei](../03-course-library/06-ai-instructions/03-prompt-dateien-grundlagen.md)
...
Quelle: [course-library/06-ai-instructions/03-prompt-dateien-grundlagen.md → Aufruf im Chat](../03-course-library/06-ai-instructions/03-prompt-dateien-grundlagen.md)
...
- ✓ `course/03-course-library/06-ai-instructions/03-prompt-dateien-grundlagen.md`: Frontmatter, Aufbau, Aufruf via `/`
- ✓ `course/03-course-library/06-ai-instructions/01-prompting-grundlagen.md`: Kontext- und Format-Baustein
