...
| In anderen Ordner wechseln | `cd <Ordnername>` | `cd <Ordnername>` | `cd course/learners/daria` navigiert in Darias Lernordner; `cd ..` geht eine Ebene hoch | `.` ist der aktuelle Ordner, `..` ist der Elternordner. |
