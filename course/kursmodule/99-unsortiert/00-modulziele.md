...
- [04-version-control-und-gitops-im-kurs.md](./04-version-control-und-gitops-im-kurs.md)
- [05-vscode-speicherkonflikt-im-kurs.md](./05-vscode-speicherkonflikt-im-kurs.md)
...
## Bausteine in diesem Kursmodul

1. **Kursspezifischer GitHub-Einstieg**
   - [01-github-im-kurs.md](./01-github-im-kurs.md)
2. **Aufgabe: Konto, Profil, Collaborator**
   - [02-github-konto-profil-und-collaborator-aufgabe.md](./02-github-konto-profil-und-collaborator-aufgabe.md)
3. **GitHub-Features, Repositories, README-Vorlage**
   - [03-github-features-repositories-und-readme-vorlage.md](./03-github-features-repositories-und-readme-vorlage.md)
   - [README-template-tn-repo.md](./README-template-tn-repo.md)
4. **Version Control und GitOps im Kurs einordnen**
   - [04-version-control-und-gitops-im-kurs.md](./04-version-control-und-gitops-im-kurs.md)
5. **VS Code Speicherkonflikt im Kurs loesen**
   - [05-vscode-speicherkonflikt-im-kurs.md](./05-vscode-speicherkonflikt-im-kurs.md)
...
1. GitHub-Grundlagen lesen (allgemein)
2. Kursspezifischen GitHub-Einstieg lesen
3. Konto/Profil/Collaborator-Aufgabe umsetzen
4. Eigenes Uebungs-Repo inkl. README anlegen
5. Mit den Uebungen in `course/uebungen/` starten
