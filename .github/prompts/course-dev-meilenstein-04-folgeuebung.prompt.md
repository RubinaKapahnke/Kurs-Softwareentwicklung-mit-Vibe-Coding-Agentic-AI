---
description: "Use when: Folgeuebung für Meilenstein 4 erstellen, meilenstein-04-uebung-02 anlegen, KI-Code lesen und kleine Logikverbesserung als Übung ausarbeiten"
name: "Meilenstein 4 Folgeuebung erstellen (course-dev)"
agent: "Exercise Creator (course-dev)"
---

Erstelle die nächste Übung für Meilenstein 4 als Datei:
...
1. Prüfe `AGENTS.md` und den Uebungsstandard.
2. Prüfe den Abschnitt Meilenstein 4 in `course/00-course-guides/COURSE_MILESTONES.md`.
3. Nutze Stil und Struktur bestehender Übungen in `course/02-course-exercises/`.
4. Verifiziere Quellenpfade, keine erfundenen Links.

Verbindliche Quellen für die neue Übung:
...
- Keine Überforderung durch grosse Refactorings
...
Nach Erstellung:
1. `course/00-course-guides/COURSE_MILESTONES.md` unter Meilenstein 4 sauber um die neue Übung erweitern.
