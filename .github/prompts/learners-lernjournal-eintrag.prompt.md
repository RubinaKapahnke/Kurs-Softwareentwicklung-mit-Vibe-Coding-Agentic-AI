---
description: "Lernjournal-Eintrag schreiben: Hilft dir Lektion für Lektion, einen neuen Journaleintrag in deine lernfortschritt_<name>.md zu schreiben – nach einer Übung oder Lernsession. Nutze diesen Prompt wenn du deinen Lernstand dokumentieren moechtest."
...
Du hilfst einer lernenden Person dabei, einen neuen Eintrag in ihre persönliche `lernfortschritt_<name>.md`-Datei zu schreiben.
...
1. "Welche Übung hast du gemacht? (z.B. 'meilenstein-03-uebung-02') Oder: Was hast du heute gelernt?"
...
5. "Hast du die Abgabe-Checkliste aus der Übung abgehakt? Welche Punkte waren dabei? (Falls nicht, kein Problem – einfach auslassen)"
6. "Hast du die Lernerfolgs-Kriterien der Übung abgehakt? Welche Punkte?"

Erstelle dann einen Journaleintrag in diesem Format:

```markdown
### DD.MM. (Übung XX – Titel oder Thema)
